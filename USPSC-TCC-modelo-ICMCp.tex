...
\programa{ECp}   % ECp = Engenharia de Computacao (portugues). NAO troque a sigla da unidade acima.
...
\include{USPSC-TA-Textual/USPSC-Cap2-FundamentacaoTeorica}
\include{USPSC-TA-Textual/USPSC-Cap3-Desenvolvimento}
\include{USPSC-TA-Textual/USPSC-Cap4-Metodologia}
\include{USPSC-TA-Textual/USPSC-Cap5-Resultados}
\include{USPSC-TA-Textual/USPSC-Cap6-Conclusao}
...
% ----------------------------------------------------------
\bibliography{USPSC-bib/USPSC-modelo-references,USPSC-bib/USPSC-modelo-references}
