...
\autor{Seu Nome Completo}          % Ex.: Maria Aparecida de Souza
\autorficha{Sobrenome, Nome}        % Formato ficha: Souza, Maria Aparecida de
\autorabr{SOBRENOME, N.}            % Formato abreviado: SOUZA, M. A.
