...
% ---
\titulo{Desenvolvimento de um Aplicativo Móvel Multiplataforma com React para Exploração Guiada no Campus ESALQ-USP
}
\autor[Sobrenome, N. A.]{João Victor de Almeida}
\orientador[Orientador:]{Prof. Dr.}{Simone do Rocio Senger de Souza}
...
\input{tex/capitulos/bibliografia}
...
\begin{apendicesenv}
    ...
    \input{tex/appendix/exemploapendice}
